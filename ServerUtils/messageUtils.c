...
{
    printf("ResponseOnSubscriptionRequest ");
    bool retVal = false;
    ...
    printf("requestId=%i; confirmationValue=%i; notificationId=%i; responseQ=%i\r\n", responseBody->requestId, responseBody->confirmationValue, responseBody->notificationId, responseQueue );
